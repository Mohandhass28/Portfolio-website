...
export const ProjectsSection = () => {
  return (
    <section className="pb-16 lg:py-24 scroll-smooth">
            ...
            >
              <div className="lg:grid lg:grid-cols-2 lg:gap-16">
                <div className="lg:pb-16">
                  ...
                  <a href="">
                    <button className="bg-white md:w-auto md:px-6 text-gray-950 h-12 w-full rounded-xl font-semibold inline-flex items-center justify-center gap-2 mt-8">
